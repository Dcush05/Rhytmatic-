...
set CLASSPATH=%APP_HOME%\lib\Rhythmatic-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" io.github.Rhythmatic.lwjgl3.Lwjgl3Launcher %*
